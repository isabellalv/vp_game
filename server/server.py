...
class InitializePreview(Resource):
    ...
    def get_sequence_info(self, feedback):
        ...
        run_info = {"index_to_run": index_to_run,
                    ...
                    "images1": sequence_info["images1"][index_to_run],
                    "images2": sequence_info["images2"][index_to_run],
                    "blocked": int(False),
                    "finished": int(False),
...
class FinalizeRun(Resource):
    def initialize_vars(self):
        ...
        print(self.data_received["responses"])
    ...
    def update_data_file(self):
        ...
        with lock:
            ...
            # Trial data
            data = {
                "response": data_received["responses"],
                "trialIndex": list(range(data_received["numTrials"])),
                #"condition": sequence_info["types"][run_index][0:num_trials],
                "image1": sequence_info["images1"][run_index][0:num_trials],
                "image2": sequence_info["images2"][run_index][0:num_trials]
            }
    ...
    def post(self):
        ...
        self.return_dict.update({"hit_rate": 1.0, "false_alarm_num": 0})
